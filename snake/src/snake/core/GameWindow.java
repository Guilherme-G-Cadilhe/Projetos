...
import snakes.graphics.Renderer;
...
public class GameWindow extends JFrame implements KeyListener {
	...
	public GameWindow(Snake snake) {
		...
		buffer = createImage(Constants.WINDOW_HEIGHT, Constants.WINDOW_WIDTH);
	...
	private void defineDrawingArea() {
		int upperY = (int) Constants.WINDOW_HEIGHT - (int) getContentPane().getSize().getHeight();
